var Massimp=function(){function f(c,d){d=void 0===d?!0:d;var b=XLSX.read(c,{type:"binary"}),l=[];b.SheetNames.forEach(function(c){var e={};d||(e.header=1);e=XLSX.utils.sheet_to_row_object_array(b.Sheets[c],e);l.push({nome:c,conteudo:e})});return l}function r(c,d,b,l){l=void 0===l?!0:l;var e=new FileReader;e.onload=function(c){try{var e=f(c.target.result,l);d(e)}catch(D){b(D)}};e.onerror=function(c){b(c)};e.readAsBinaryString(c.files[0])}function x(c,b){var d=Object.assign({},c);b.forEach(function(c,
    ...
    if(null!=d&&null!=d.attributes&&"object"===typeof d.attributes){Object.keys(d.attributes).forEach(function(a,b){var c=!0;"NaN"===typeof parseInt(a)&&(c=!1);var e={valor:"",titulo:"",isImage:!1};null!=d.attributes[c?b:a].valor&&(e.valor=d.attributes[c?b:a].valor);null!=d.attributes[c?b:a].titulo&&(e.titulo=d.attributes[c?b:a].titulo);null!=d.attributes[c?b:a].isImage&&(e.isImage=d.attributes[c?b:a].isImage);h.push(e)});for(var l=[],f=0;f<h.length;f++){var q=G(h,h[f].valor,"valor");1<q.length&&q.forEach(function(a,
