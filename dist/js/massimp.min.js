var Massimp=function(){function f(c,d){d=void 0===d?!0:d;var b=XLSX.read(c,{type:"binary"}),l=[];b.SheetNames.forEach(function(c){var e={};d||(e.header=1);e=XLSX.utils.sheet_to_row_object_array(b.Sheets[c],e);l.push({nome:c,conteudo:e})});return l}function r(c,d,b,l){l=void 0===l?!0:l;var e=new FileReader;e.onload=function(c){try{var e=f(c.target.result,l);d(e)}catch(D){b(D)}};e.onerror=function(c){b(c)};e.readAsBinaryString(c.files[0])}function y(c,b){var d=Object.assign({},c);b.forEach(function(c,
    ...
    !0);t.appendChild(e)}else u||(u=!0)});g=document.createElement("td");g.classList.add("massimp-attribute-col");g.appendChild(t);var n=document.createElement("tr");n.appendChild(e);if(a){e=document.createElement("span");e.innerHTML=b;var k=document.createElement("td");k.classList.add("massimp-column-col");k.appendChild(e);n.appendChild(k)}n.appendChild(g);d.appendChild(n)});c.style.display=null}},_removeColumnAssociationTable:function(){var a=this._getTableDivElement(),b=this._getTableBodyElement(),
    ...
    h[b].title;1==h[b].isImage&&(d.style.textAlign="center");g.appendChild(d)}});e.appendChild(g)}var t=document.createElement("tr"),f=0;Object.keys(h).forEach(function(d,e){if((null==h[d].isImage||0==h[d].isImage)&&null!=a[h[d].value]||1==h[d].isImage){var g=document.createElement("td");g.classList.add("massimp-attribute-"+h[d].value);var l=document.createElement("span");if(1==h[d].isImage){g.style.textAlign="center";l=document.createElement("a");l.setAttribute("href","javascript:void(0);");l.classList.add("massimp-lightbox");
    l.id="massimp-lightbox-"+c.toString()+"-"+f.toString();var n=document.createElement("img");n.id="massimp-anchorimg-"+c.toString()+"-"+f.toString();var k=document.createElement("span");k.style.cursor="pointer";k.style.color="white";k.style.position="absolute";k.style.right="20px";k.style.top="20px";k.style.fontSize="70px";k.setAttribute("title",b._getStringList().close);k.innerHTML="&#10008;";k.onclick=function(){location.href="#_"};l.appendChild(k);l.appendChild(n);n=document.createElement("img");
    n.id="massimp-image-"+c.toString()+"-"+f.toString();n.style.display="none";n.style.objectFit="contain";n.style.width="65px";n.style.cursor="pointer";n.classList.add("responsive-img");n.classList.add("massimp-img-thumbnail");n.onclick=function(){var a="massimp-lightbox"+this.id.substr(13,this.id.length);location.href="#"+a};var m=document.createElement("input");k=document.createElement("button");var p=document.createElement("button");m.setAttribute("type","file");m.setAttribute("accept","image/*");
    m.style.display="none";m.id="massimp-input-"+c.toString()+"-"+f.toString();m.onchange=function(a){a=m.id.substr(0,8)+"anchorimg"+m.id.substr(13,m.id.length);var c=document.getElementById(a);a=m.id.substr(0,8)+"image"+m.id.substr(13,m.id.length);var d=document.getElementById(a);a=m.id.substr(0,8)+"button"+m.id.substr(13,m.id.length);var e=document.getElementById(a);a=m.id.substr(0,8)+"clear-button"+m.id.substr(13,m.id.length);a=document.getElementById(a);if(0<m.files.length){var g=new FileReader;g.onload=
    function(a){e.innerHTML=b._getStringList().change;d.setAttribute("src",a.target.result);d.setAttribute("title",m.files[0].name);c.setAttribute("src",a.target.result)};g.readAsDataURL(m.files[0]);d.style.display=null;a.style.display=null}else e.innerHTML=b._getStringList().open,d.removeAttribute("src"),d.style.display="none",a.style.display="none"};k.setAttribute("type","button");k.classList.add("btn");k.id="massimp-button-"+c.toString()+"-"+f.toString();k.innerHTML=b._getStringList().open;k.onclick=
    function(){var a=this.id.substr(0,8)+"input"+this.id.substr(14,this.id.length);document.getElementById(a).click()};p.setAttribute("type","button");p.setAttribute("title",b._getStringList().remove);p.classList.add("btn-flat");p.classList.add("red-text");p.id="massimp-clear-button-"+c.toString()+"-"+f.toString();p.innerHTML="&#10006;";p.style.display="none";p.onclick=function(){var a=p.id.substr(0,8)+"input"+p.id.substr(20,p.id.length);a=document.getElementById(a);var c=p.id.substr(0,8)+"image"+p.id.substr(20,
    p.id.length);c=document.getElementById(c);var d=p.id.substr(0,8)+"button"+p.id.substr(20,p.id.length);d=document.getElementById(d);var e=a.parentNode;document.tempForm=document.createElement("form");document.tempForm.appendChild(a);document.tempForm.reset();e.appendChild(document.tempForm.childNodes[0]);c.removeAttribute("src");c.style.display="none";d.innerHTML=b._getStringList().open;p.style.display="none"};g.appendChild(l);g.appendChild(n);g.appendChild(document.createElement("br"));g.appendChild(m);
    g.appendChild(k);g.appendChild(document.createElement("br"));g.appendChild(p)}else l.innerHTML=a[h[d].value],g.appendChild(l);t.appendChild(g);f++}});d.appendChild(t)}),c.style.display=null,u=!1)},_removeImageAssociationTable:function(){var a=this._getTableResultDivElement(),b=this._getTableResultBodyElement(),c=this._getTableResultHeadElement();if(null!=a&&null!=b){for(;c.firstChild;)c.removeChild(c.firstChild);for(;b.firstChild;)b.removeChild(b.firstChild);a.style.display="none"}},_processImages:function(a){var b=
    ...
    for(var l=[],f=0;f<h.length;f++){var q=G(h,h[f].value,"value");1<q.length&&q.forEach(function(a,b){0<b&&(l.includes(a)||l.push(a))})}l.forEach(function(a,b){delete h[a]})}var F=function(a){try{var c=a.parentNode;document.tempForm=document.createElement("form");document.tempForm.appendChild(a);document.tempForm.reset();c.appendChild(document.tempForm.childNodes[0]);b.get(e)._removeImageAssociationTable();b.get(e)._removeColumnAssociationTable();var d=b.get(e)._getInputFileInsideTextElement();null!=
    a&&(d.removeAttribute("readonly"),d.classList.remove("valid"),d.classList.remove("invalid"),d.value=null);b.get(e)._getClearInputFileGroupElement().style.display="none";b.get(e)._getSheetsRadioElements().style.display="none";b.get(e)._getRadioElements().forEach(function(a,b){a.removeAttribute("disabled")});b.get(e)._getDefaultButtonElement().style.display="none";var f=b.get(e)._getRadioHasHeaderElement(),l=JSON.parse(f.value);w=null;x=0;E=l;u=!1;v=!0}catch(n){b.get(e)._onError(n)}},D=b.get(this)._getStringList().list;
    null!=b.get(this).options&&null!=b.get(this).options.inputFileText&&"string"===typeof b.get(this).options.inputFileText&&(D=b.get(this).options.inputFileText);var H=b.get(this)._getStringList().fileChoose;null!=d&&null!=d.inputFileInsideText&&"string"===typeof d.inputFileInsideText&&(H=d.inputFileInsideText);var B=b.get(this)._getInputFileElement();B.onchange=function(){try{if(null!=B.files[0]){b.get(e)._removeColumnAssociationTable();b.get(e)._removeImageAssociationTable();var a=b.get(e)._getInputFileInsideTextElement();
    a.setAttribute("readonly",!0);a.classList.remove("invalid");a.classList.add("valid");a.value=B.files[0].name;b.get(e)._getClearInputFileGroupElement().style.display=null;var c=b.get(e)._getRadioHasHeaderElement(),f=JSON.parse(c.value);b.get(e)._processFile(B,f,function(a){b.get(e)._showColumnAssociationTable(f,0);var c=5;null!=d&&null!=d.maxVerticalRowsToDisplay&&"number"===typeof d.maxVerticalRowsToDisplay&&(c=d.maxVerticalRowsToDisplay);e.setMaxVerticalRowsToDisplay(c);1<a.length&&b.get(e)._showSheetSelection(a,
    function(a){x=parseInt(a.value);b.get(e)._removeImageAssociationTable();b.get(e)._showColumnAssociationTable(f,x);a=5;null!=d&&null!=d.maxVerticalRowsToDisplay&&"number"===typeof d.maxVerticalRowsToDisplay&&(a=d.maxVerticalRowsToDisplay);e.setMaxVerticalRowsToDisplay(a)});b.get(e)._getRadioElements().forEach(function(a,b){a.setAttribute("disabled",!0)});b.get(e)._getDefaultButtonElement().style.display=null});w=null;x=0;E=f;u=!1;v=!0}else F(B)}catch(L){b.get(e)._onError(L)}};b.get(this)._getClearInputFileElement().onclick=
    function(){try{var a=b.get(e)._getInputFileElement();F(a)}catch(g){b.get(e)._onError(g)}};this.setInputFileInsideText(H);this.setInputFileText(D);f=5;null!=d&&null!=d.maxVerticalRowsToDisplay&&"number"===typeof d.maxVerticalRowsToDisplay&&(f=d.maxVerticalRowsToDisplay);this.setMaxVerticalRowsToDisplay(f);f="blue";null!=d&&null!=d.colorButtonClass&&"string"===typeof d.colorButtonClass&&(f=d.colorButtonClass);var C=b.get(this)._getStringList().defaultButtonText;null!=d&&null!=d.buttonText&&"string"===
    typeof d.buttonText&&(C=d.buttonText);q=function(){try{u?b.get(e)._process(!1,function(a){b.get(e)._showImageAssociationTable(a);v=!1}):v?b.get(e)._process(!0,null):b.get(e)._processImages(null)}catch(a){b.get(e)._onError(a)}};null!=d&&null!=d.onButtonClicked&&"function"===typeof d.onButtonClicked&&(q=function(){try{u?b.get(e)._process(!1,function(a){b.get(e)._showImageAssociationTable(a);v=!1}):v?b.get(e)._process(!0,d.onButtonClicked):b.get(e)._processImages(d.onButtonClicked)}catch(a){b.get(e)._onError(a)}});
    this.setColorButtonClass(f);this.setButtonText(C);var I=b.get(this)._getDefaultButtonElement();I.onclick=q;I.style.display="none";C=!1;null!=d&&null!=d.showExtraButton&&"boolean"===typeof d.showExtraButton&&(C=d.showExtraButton);this.setShowExtraButton(C)}catch(a){b.get(this)._onError(a)}};q.prototype.setInputFileText=function(c){c=void 0===c?b.get(this)._getStringList().list:c;try{var d=b.get(this)._getInputFileTextElement();null!=c&&"string"===typeof c&&0<c.length&&(d.innerHTML=c)}catch(e){b.get(this)._onError(e)}};
    q.prototype.setInputFileInsideText=function(c){c=void 0===c?b.get(this)._getStringList().fileChoose:c;try{var d=b.get(this)._getInputFileInsideTextElement();null!=c&&(d.placeHolder=c)}catch(e){b.get(this)._onError(e)}};q.prototype.setMaxVerticalRowsToDisplay=function(c,d){c=void 0===c?5:c;d=void 0===d?!1:d;try{var e=446;if(null!=c&&"number"===typeof c){var f=b.get(this)._getTableBodyElement().getElementsByTagName("tr").length;e=d&&c>=f?127+75*(f-1):127+75*(c-1)}b.get(this)._getTableDivElement().style.maxHeight=
    e.toString()+"px"}catch(J){b.get(this)._onError(J)}};q.prototype.getNumberOfObjects=function(){var c=0;try{null!=w&&(c=w[x].conteudo.length)}catch(d){b.get(this)._onError(d)}return c};q.prototype.setColorButtonClass=function(c){c=void 0===c?"blue":c;try{var d=b.get(this)._getDefaultButtonElement();null!=c&&"string"===typeof c&&0<c.length&&(d.removeAttribute("class"),d.classList.add("btn"),d.classList.add("waves-effect"),d.classList.add("waves-light"),d.classList.add("massimp-default-button"),d.classList.add(c))}catch(e){b.get(this)._onError(e)}};
    q.prototype.setButtonText=function(c){c=void 0===c?b.get(this)._getStringList().defaultButtonText:c;try{var d=b.get(this)._getDefaultButtonElement();null!=c&&"string"===typeof c&&0<c.length&&(d.innerHTML=c)}catch(e){b.get(this)._onError(e)}};q.prototype.setColorExtraButtonClass=function(c){c=void 0===c?"red":c;try{var d=b.get(this)._getExtraButtonElement();null!=c&&"string"===typeof c&&0<c.length&&(d.removeAttribute("class"),d.classList.add("btn"),d.classList.add("waves-effect"),d.classList.add("waves-light"),
    d.classList.add("massimp-extra-button"),d.classList.add(c))}catch(e){b.get(this)._onError(e)}};q.prototype.setExtraButtonText=function(c){c=void 0===c?b.get(this)._getStringList().extraButtonText:c;try{var d=b.get(this)._getExtraButtonElement();null!=c&&"string"===typeof c&&0<c.length&&(d.innerHTML=c)}catch(e){b.get(this)._onError(e)}};q.prototype.setShowExtraButton=function(c){c=void 0===c?!1:c;try{var d=b.get(this)._getButtonsGroupElement(),e=b.get(this)._getExtraButtonElement();if(null!=e&&(d.removeChild(e),
    c)){var f=document.createElement("button");f.setAttribute("type","button");f.classList.add("btn");f.classList.add("red");f.classList.add("waves-effect");f.classList.add("waves-light");f.classList.add("massimp-extra-button");f.innerHTML=b.get(this)._getStringList().extraButtonText;d.appendChild(f);c="red";null!=b.get(this).options&&null!=b.get(this).options.colorExtraButtonClass&&"string"===typeof b.get(this).options.colorExtraButtonClass&&(c=b.get(this).options.colorExtraButtonClass);var h=b.get(this)._getStringList().extraButtonText;
    null!=b.get(this).options&&null!=b.get(this).options.extraButtonText&&"string"===typeof b.get(this).options.extraButtonText&&(h=b.get(this).options.extraButtonText);d=null;null!=b.get(this).options&&null!=b.get(this).options.onExtraButtonClicked&&"function"===typeof b.get(this).options.onExtraButtonClicked&&(d=b.get(this).options.onExtraButtonClicked);b.get(this)._setColorExtraButtonClass(c);b.get(this)._setExtraButtonText(h);f.onclick=d}}catch(K){b.get(this)._onError(K)}};q.prototype.processMassiveImport=
    function(c){var d=this;c=void 0===c?null:c;try{u?b.get(this)._process(!1,function(c){b.get(d)._showImageAssociationTable(c);v=!1}):v?b.get(this)._process(!0,c):b.get(this)._processImages(c)}catch(e){b.get(this)._onError(e)}};return q}(),massimpMainFunction=function(f,r,y,G){f=void 0===f?{}:f;r=void 0===r?null:r;y=!1;thisElement=this;null!=this[0]&&(thisElement=this[0],y=!0);if("object"===typeof f)null==thisElement._massimp&&(thisElement._massimp=new Massimp(thisElement,f));else if(y&&"string"===typeof f&&
    null!=thisElement._massimp)if("setInputFileText"==f)thisElement._massimp.setInputFileText(r);else if("setInputFileInsideText"==f)thisElement._massimp.setInputFileInsideText(r);else if("setMaxVerticalRowsToDisplay"==f)thisElement._massimp.setMaxVerticalRowsToDisplay(r);else{if("getNumberOfObjects"==f)return thisElement._massimp.getNumberOfObjects();"setColorButtonClass"==f?thisElement._massimp.setColorButtonClass(r):"setButtonText"==f?thisElement._massimp.setButtonText(r):"setColorExtraButtonClass"==
    f?thisElement._massimp.setColorExtraButtonClass(r):"setExtraButtonText"==f?thisElement._massimp.setExtraButtonText(r):"setShowExtraButton"==f?thisElement._massimp.setShowExtraButton(r):"processMassiveImport"==f?thisElement._massimp.processMassiveImport(function(f){$(thisElement).trigger("after.mp.process",[f])}):console.error("Massimp error: Method not found")}else console.error("Massimp error: Invalid initialization")};null!=window.jQuery&&($.fn.massimp=massimpMainFunction);
