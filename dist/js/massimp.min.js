var Massimp=function(){function f(c,d){d=void 0===d?!0:d;var b=XLSX.read(c,{type:"binary"}),l=[];b.SheetNames.forEach(function(c){var e={};d||(e.header=1);e=XLSX.utils.sheet_to_row_object_array(b.Sheets[c],e);l.push({nome:c,conteudo:e})});return l}function r(c,d,b,l){l=void 0===l?!0:l;var e=new FileReader;e.onload=function(c){try{var e=f(c.target.result,l);d(e)}catch(D){b(D)}};e.onerror=function(c){b(c)};e.readAsBinaryString(c.files[0])}function x(c,b){var d=Object.assign({},c);b.forEach(function(c,
    ...
    d.toString());e.classList.add("with-gap");0==d&&e.setAttribute("checked",!0);e.onchange=b;var g=document.createElement("span");g.innerHTML=a.nome;var t=document.createElement("label");t.classList.add("massimp-radio");t.appendChild(e);t.appendChild(g);e=document.createElement("p");e.appendChild(t);c.appendChild(e)});c.style.display=null},_removeSheetSelection:function(){var a=this._getSheetsRadioElements();if(null!=a){for(;a.firstChild;)a.removeChild(a.firstChild);a.style.display="none"}},_showImageAssociationTable:function(a){var b=
    this,c=this._getTableResultDivElement(),d=this._getTableResultBodyElement(),e=this._getTableResultHeadElement();null!=c&&null!=d&&null!=e&&0<h.length&&(this._removeImageAssociationTable(),a.forEach(function(a,c){if(0==c){var g=document.createElement("tr");Object.keys(h).forEach(function(b,c){if((null==h[b].isImage||0==h[b].isImage)&&null!=a[h[b].value]||1==h[b].isImage){var d=document.createElement("th");d.setAttribute("scope","col");d.innerHTML=h[b].title;1==h[b].isImage&&(d.style.textAlign="center");
    g.appendChild(d)}});e.appendChild(g)}var t=document.createElement("tr"),f=0;Object.keys(h).forEach(function(d,e){if((null==h[d].isImage||0==h[d].isImage)&&null!=a[h[d].value]||1==h[d].isImage){var g=document.createElement("td");g.classList.add("massimp-attribute-"+h[d].value);var l=document.createElement("span");if(1==h[d].isImage){g.style.textAlign="center";l=document.createElement("a");l.setAttribute("href","javascript:void(0);");l.classList.add("massimp-lightbox");l.id="massimp-lightbox-"+c.toString()+
    "-"+f.toString();var k=document.createElement("img");k.id="massimp-anchorimg-"+c.toString()+"-"+f.toString();var m=document.createElement("span");m.style.cursor="pointer";m.style.color="white";m.style.position="absolute";m.style.right="20px";m.style.top="20px";m.style.fontSize="70px";m.setAttribute("title",b._getStringList().close);m.innerHTML="&#10008;";m.onclick=function(){location.href="#_"};l.appendChild(m);l.appendChild(k);k=document.createElement("img");k.id="massimp-image-"+c.toString()+"-"+
    f.toString();k.style.display="none";k.style.objectFit="contain";k.style.width="65px";k.style.cursor="pointer";k.classList.add("responsive-img");k.classList.add("massimp-img-thumbnail");k.onclick=function(){var a="massimp-lightbox"+this.id.substr(13,this.id.length);location.href="#"+a};var n=document.createElement("input");m=document.createElement("button");var p=document.createElement("button");n.setAttribute("type","file");n.setAttribute("accept","image/*");n.style.display="none";n.id="massimp-input-"+
    c.toString()+"-"+f.toString();n.onchange=function(a){a=n.id.substr(0,8)+"anchorimg"+n.id.substr(13,n.id.length);var c=document.getElementById(a);a=n.id.substr(0,8)+"image"+n.id.substr(13,n.id.length);var d=document.getElementById(a);a=n.id.substr(0,8)+"button"+n.id.substr(13,n.id.length);var e=document.getElementById(a);a=n.id.substr(0,8)+"clear-button"+n.id.substr(13,n.id.length);a=document.getElementById(a);if(0<n.files.length){var g=new FileReader;g.onload=function(a){e.innerHTML=b._getStringList().change;
    d.setAttribute("src",a.target.result);d.setAttribute("title",n.files[0].name);c.setAttribute("src",a.target.result)};g.readAsDataURL(n.files[0]);d.style.display=null;a.style.display=null}else e.innerHTML=b._getStringList().open,d.removeAttribute("src"),d.style.display="none",a.style.display="none"};m.setAttribute("type","button");m.classList.add("btn");m.id="massimp-button-"+c.toString()+"-"+f.toString();m.innerHTML=b._getStringList().open;m.onclick=function(){var a=this.id.substr(0,8)+"input"+this.id.substr(14,
    this.id.length);document.getElementById(a).click()};p.setAttribute("type","button");p.setAttribute("title",b._getStringList().remove);p.classList.add("btn-flat");p.classList.add("red-text");p.id="massimp-clear-button-"+c.toString()+"-"+f.toString();p.innerHTML="&#10006;";p.style.display="none";p.onclick=function(){var a=p.id.substr(0,8)+"input"+p.id.substr(20,p.id.length);a=document.getElementById(a);var c=p.id.substr(0,8)+"image"+p.id.substr(20,p.id.length);c=document.getElementById(c);var d=p.id.substr(0,
    8)+"button"+p.id.substr(20,p.id.length);d=document.getElementById(d);var e=a.parentNode;document.tempForm=document.createElement("form");document.tempForm.appendChild(a);document.tempForm.reset();e.appendChild(document.tempForm.childNodes[0]);c.removeAttribute("src");c.style.display="none";d.innerHTML=b._getStringList().open;p.style.display="none"};g.appendChild(l);g.appendChild(k);g.appendChild(document.createElement("br"));g.appendChild(n);g.appendChild(m);g.appendChild(document.createElement("br"));
    g.appendChild(p)}else l.innerHTML=a[h[d].value],g.appendChild(l);t.appendChild(g);f++}});d.appendChild(t)}),c.style.display=null,u=!1)},_removeImageAssociationTable:function(){var a=this._getTableResultDivElement(),b=this._getTableResultBodyElement(),c=this._getTableResultHeadElement();if(null!=a&&null!=b){for(;c.firstChild;)c.removeChild(c.firstChild);for(;b.firstChild;)b.removeChild(b.firstChild);a.style.display="none"}},_processImages:function(a){var b=this;a=void 0===a?null:a;this._process(!1,
    function(c){var d=b._getTableResultBodyElement();null!=d&&c.forEach(function(a,b){var c=d.childNodes[b];c.querySelectorAll("td").forEach(function(b,d){Array.from(b.classList).filter(function(b,c){var d=!0;Object.keys(a).forEach(function(a,c){if(b.substr(18,b.length)==a)return d=!1});return d}).forEach(function(b,d){var e=c.getElementsByClassName(b)[0].getElementsByTagName("input")[0];null!=e&&0<e.files.length?a[b.substr(18,b.length)]=e.files[0]:a[b.substr(18,b.length)]=null})})});var e=!1;c.forEach(function(a,
    b){Object.keys(a).forEach(function(b,c){if(null!=a[b])return e=!0,!1});if(e)return!1});if(e&&null!=a&&"function"===typeof a)u=!0,b._removeImageAssociationTable(),a(c);else if(!e)throw b._getStringList().noDataProcessed;})},_process:function(a,b){a=void 0===a?!0:a;b=void 0===b?null:b;var c=this._getInputFileElement();if(null!=c&&0<c.files.length){var d=[],e=!1;a||(e=!0);c=this._getTableBodyElement();if(null!=c){var g=[];NodeList.prototype.forEach=Array.prototype.forEach;c.childNodes.forEach(function(a,
    b){var c=a.getElementsByClassName("massimp-attribute-col")[0].getElementsByTagName("select")[0].value;if(0!=c){e||(e=!0);var d={from:b,to:c};E&&(d={from:a.getElementsByClassName("massimp-column-col")[0].getElementsByTagName("span")[0].innerHTML,to:c});g.push(d)}});e&&w[A].conteudo.forEach(function(a,b){var c=x(a,g);Object.keys(c).forEach(function(a,b){g.find(function(b){return b.to==a})||delete c[a]});h.forEach(function(a,b){null==a.value||null!=c[a.value]||null!=a.isImage&&0!=a.isImage||(c[a.value]=
    null)});d.push(c)})}if(e&&null!=b&&"function"===typeof b)b(d);else if(!e)throw this._getStringList().noAttributeAssociated;}else throw this._getStringList().noFileSet;},_onError:function(a){if(null!=this.options&&null!=this.options.onError&&"function"===typeof this.options.onError)this.options.onError(a);else console.error(a)}});try{b.get(this)._loadHTML();null!=d&&null!=d.language&&"string"===typeof d.language&&(Object.keys(y).includes(d.language.toLowerCase())?z=d.language:b.get(this)._onError(b.get(this)._getStringList().languageNotSupported));
    if(null!=d&&null!=d.attributes&&"object"===typeof d.attributes){Object.keys(d.attributes).forEach(function(a,b){var c=!0;"NaN"===typeof parseInt(a)&&(c=!1);var e={value:"",title:"",isImage:!1};null!=d.attributes[c?b:a].value&&(e.value=d.attributes[c?b:a].value);null!=d.attributes[c?b:a].title&&(e.title=d.attributes[c?b:a].title);null!=d.attributes[c?b:a].isImage&&(e.isImage=d.attributes[c?b:a].isImage);h.push(e)});for(var l=[],f=0;f<h.length;f++){var q=G(h,h[f].value,"value");1<q.length&&q.forEach(function(a,
    b){0<b&&(l.includes(a)||l.push(a))})}l.forEach(function(a,b){delete h[a]})}var F=function(a){try{var c=a.parentNode;document.tempForm=document.createElement("form");document.tempForm.appendChild(a);document.tempForm.reset();c.appendChild(document.tempForm.childNodes[0]);b.get(e)._removeImageAssociationTable();b.get(e)._removeColumnAssociationTable();var d=b.get(e)._getInputFileInsideTextElement();null!=a&&(d.removeAttribute("readonly"),d.classList.remove("valid"),d.classList.remove("invalid"),d.value=
    null);b.get(e)._getClearInputFileGroupElement().style.display="none";b.get(e)._getSheetsRadioElements().style.display="none";b.get(e)._getRadioElements().forEach(function(a,b){a.removeAttribute("disabled")});b.get(e)._getDefaultButtonElement().style.display="none";var f=b.get(e)._getRadioHasHeaderElement(),l=JSON.parse(f.value);w=null;A=0;E=l;u=!1;v=!0}catch(m){b.get(e)._onError(m)}},D=b.get(this)._getStringList().list;null!=b.get(this).options&&null!=b.get(this).options.inputFileText&&"string"===
    typeof b.get(this).options.inputFileText&&(D=b.get(this).options.inputFileText);var H=b.get(this)._getStringList().fileChoose;null!=d&&null!=d.inputFileInsideText&&"string"===typeof d.inputFileInsideText&&(H=d.inputFileInsideText);var B=b.get(this)._getInputFileElement();B.onchange=function(){try{if(null!=B.files[0]){b.get(e)._removeColumnAssociationTable();b.get(e)._removeImageAssociationTable();var a=b.get(e)._getInputFileInsideTextElement();a.setAttribute("readonly",!0);a.classList.remove("invalid");
    a.classList.add("valid");a.value=B.files[0].name;b.get(e)._getClearInputFileGroupElement().style.display=null;var c=b.get(e)._getRadioHasHeaderElement(),f=JSON.parse(c.value);b.get(e)._processFile(B,f,function(a){b.get(e)._showColumnAssociationTable(f,0);var c=5;null!=d&&null!=d.maxVerticalRowsToDisplay&&"number"===typeof d.maxVerticalRowsToDisplay&&(c=d.maxVerticalRowsToDisplay);e.setMaxVerticalRowsToDisplay(c);1<a.length&&b.get(e)._showSheetSelection(a,function(){A=parseInt(radPlanilha.value);b.get(e)._showColumnAssociationTable(f,
    sheetIndex);var a=5;null!=d&&null!=d.maxVerticalRowsToDisplay&&"number"===typeof d.maxVerticalRowsToDisplay&&(a=d.maxVerticalRowsToDisplay);e.setMaxVerticalRowsToDisplay(a)});b.get(e)._getRadioElements().forEach(function(a,b){a.setAttribute("disabled",!0)});b.get(e)._getDefaultButtonElement().style.display=null});w=null;A=0;E=f;u=!1;v=!0}else F(B)}catch(L){b.get(e)._onError(L)}};b.get(this)._getClearInputFileElement().onclick=function(){try{var a=b.get(e)._getInputFileElement();F(a)}catch(g){b.get(e)._onError(g)}};
    this.setInputFileInsideText(H);this.setInputFileText(D);f=5;null!=d&&null!=d.maxVerticalRowsToDisplay&&"number"===typeof d.maxVerticalRowsToDisplay&&(f=d.maxVerticalRowsToDisplay);this.setMaxVerticalRowsToDisplay(f);f="blue";null!=d&&null!=d.colorButtonClass&&"string"===typeof d.colorButtonClass&&(f=d.colorButtonClass);var C=b.get(this)._getStringList().defaultButtonText;null!=d&&null!=d.buttonText&&"string"===typeof d.buttonText&&(C=d.buttonText);q=function(){try{u?b.get(e)._process(!1,function(a){b.get(e)._showImageAssociationTable(a);
    ...
    "none";C=!1;null!=d&&null!=d.showExtraButton&&"boolean"===typeof d.showExtraButton&&(C=d.showExtraButton);this.setShowExtraButton(C)}catch(a){b.get(this)._onError(a)}};q.prototype.setInputFileText=function(c){c=void 0===c?b.get(this)._getStringList().list:c;try{var d=b.get(this)._getInputFileTextElement();null!=c&&"string"===typeof c&&0<c.length&&(d.innerHTML=c)}catch(e){b.get(this)._onError(e)}};q.prototype.setInputFileInsideText=function(c){c=void 0===c?b.get(this)._getStringList().fileChoose:c;
    try{var d=b.get(this)._getInputFileInsideTextElement();null!=c&&(d.placeHolder=c)}catch(e){b.get(this)._onError(e)}};q.prototype.setMaxVerticalRowsToDisplay=function(c,d){c=void 0===c?5:c;d=void 0===d?!1:d;try{var e=446;if(null!=c&&"number"===typeof c){var f=b.get(this)._getTableBodyElement().getElementsByTagName("tr").length;e=d&&c>=f?127+75*(f-1):127+75*(c-1)}b.get(this)._getTableDivElement().style.maxHeight=e.toString()+"px"}catch(J){b.get(this)._onError(J)}};q.prototype.getNumberOfObjects=function(){var c=
    0;try{null!=w&&(c=w[A].conteudo.length)}catch(d){b.get(this)._onError(d)}return c};q.prototype.setColorButtonClass=function(c){c=void 0===c?"blue":c;try{var d=b.get(this)._getDefaultButtonElement();null!=c&&"string"===typeof c&&0<c.length&&(d.removeAttribute("class"),d.classList.add("btn"),d.classList.add("waves-effect"),d.classList.add("waves-light"),d.classList.add("massimp-default-button"),d.classList.add(c))}catch(e){b.get(this)._onError(e)}};q.prototype.setButtonText=function(c){c=void 0===c?
    b.get(this)._getStringList().defaultButtonText:c;try{var d=b.get(this)._getDefaultButtonElement();null!=c&&"string"===typeof c&&0<c.length&&(d.innerHTML=c)}catch(e){b.get(this)._onError(e)}};q.prototype.setColorExtraButtonClass=function(c){c=void 0===c?"red":c;try{var d=b.get(this)._getExtraButtonElement();null!=c&&"string"===typeof c&&0<c.length&&(d.removeAttribute("class"),d.classList.add("btn"),d.classList.add("waves-effect"),d.classList.add("waves-light"),d.classList.add("massimp-extra-button"),
    d.classList.add(c))}catch(e){b.get(this)._onError(e)}};q.prototype.setExtraButtonText=function(c){c=void 0===c?b.get(this)._getStringList().extraButtonText:c;try{var d=b.get(this)._getExtraButtonElement();null!=c&&"string"===typeof c&&0<c.length&&(d.innerHTML=c)}catch(e){b.get(this)._onError(e)}};q.prototype.setShowExtraButton=function(c){c=void 0===c?!1:c;try{var d=b.get(this)._getButtonsGroupElement(),e=b.get(this)._getExtraButtonElement();if(null!=e&&(d.removeChild(e),c)){var f=document.createElement("button");
    f.setAttribute("type","button");f.classList.add("btn");f.classList.add("red");f.classList.add("waves-effect");f.classList.add("waves-light");f.classList.add("massimp-extra-button");f.innerHTML=b.get(this)._getStringList().extraButtonText;d.appendChild(f);c="red";null!=b.get(this).options&&null!=b.get(this).options.colorExtraButtonClass&&"string"===typeof b.get(this).options.colorExtraButtonClass&&(c=b.get(this).options.colorExtraButtonClass);var h=b.get(this)._getStringList().extraButtonText;null!=
    b.get(this).options&&null!=b.get(this).options.extraButtonText&&"string"===typeof b.get(this).options.extraButtonText&&(h=b.get(this).options.extraButtonText);d=null;null!=b.get(this).options&&null!=b.get(this).options.onExtraButtonClicked&&"function"===typeof b.get(this).options.onExtraButtonClicked&&(d=b.get(this).options.onExtraButtonClicked);b.get(this)._setColorExtraButtonClass(c);b.get(this)._setExtraButtonText(h);f.onclick=d}}catch(K){b.get(this)._onError(K)}};q.prototype.processMassiveImport=
    function(c){var d=this;c=void 0===c?null:c;try{u?b.get(this)._process(!1,function(c){b.get(d)._showImageAssociationTable(c);v=!1}):v?b.get(this)._process(!0,c):b.get(this)._processImages(c)}catch(e){b.get(this)._onError(e)}};return q}(),massimpMainFunction=function(f,r,x,G){f=void 0===f?{}:f;r=void 0===r?null:r;x=!1;thisElement=this;null!=this[0]&&(thisElement=this[0],x=!0);if("object"===typeof f)null==thisElement._massimp&&(thisElement._massimp=new Massimp(thisElement,f));else if(x&&"string"===typeof f&&
